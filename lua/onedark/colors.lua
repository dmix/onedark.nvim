...
local colors = {
        black = { '#17191e', '#1e1e1e' , '#151820' , '#0c0e15' , '#191a1c' , '#101012' },
          bg0 = { '#282c34', '#0E1116' , '#242b38' , '#1a212e' , '#2c2d30' , '#232326' },
          bg1 = { '#31353f', '#222222' , '#2d3343' , '#21283b' , '#35373b' , '#2c2d31' },
          bg2 = { '#393f4a', '#30363f' , '#343e4f' , '#283347' , '#3e4045' , '#35363b' },
          bg3 = { '#3b3f4c', '#323641' , '#363c51' , '#2a324a' , '#404247' , '#37383d' },
         bg_d = { '#21252b', '#0E1116' , '#1e242e' , '#141b24' , '#242628' , '#1b1c1e' },
